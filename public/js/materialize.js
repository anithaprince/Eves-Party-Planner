...
$(document).ready(function() {
	...
	$(add_button).click(function(e){ //on add input button click
		...
		if(x < max_fields){ //max input box allowed
			...
			$(wrapper).append('<div><input type="text" class="validate" name="highlights"><a href="#" class="remove_field"><i class="material-icons">remove_circle</i></a></div>'); //add input box
		}
	});
